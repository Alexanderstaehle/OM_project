...
def optimize(train_datalaoder, test_dataloader, batch_size, model, optimizer, criterion, learning_rate, epochs):
    train_cost = []
    train_acc = []
    ...
    for epoch in range(epochs):
        ...
        for i, (batch_X, batch_Y) in enumerate(train_dataloader):
            ...
            if i % 200 == 0:
                print("Epoch= {},\t batch = {},\t cost = {:2.4f},\t accuracy = {}".format(epoch+1, i, train_cost[-1], train_acc[-1]))
...
optimize(test_dataloader, test_dataloader, batch_size, model, optimizer, criterion, learning_rate, training_epochs)